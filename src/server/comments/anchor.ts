import type { CommentAnchor, CommentThread } from '../../shared/protocol.js';
 ...
 */
export function relocate(anchor: CommentAnchor, contents: string): CommentAnchor | null {
  const lines = splitLines(contents);
...
/** Review order: by path, then line, then when the thread was opened. */
